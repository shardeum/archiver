...
describe('GossipData', () => {
    ...
    it('should populate remainingArchivers with non-adjacent archivers', () => {
      ...
      expect(Utils.getRandomItemFromArr).toHaveBeenCalledWith(
        expect.arrayContaining([
          expect.objectContaining({ publicKey: mockOtherArchiver1.publicKey }),
  ...
  describe('sendDataToAdjacentArchivers', () => {
    ...
    it('should handle crypto error case by logging error and calling nestedCounter', async () => {
      ...
      expect(require('../../../../src/profiler/nestedCounters').nestedCountersInstance.countEvent).toHaveBeenCalledWith(
        'gossip-data',
        'error 2',
        expect.any(Error)
      )
    ...
    it('should handle errors during signing', async () => {
      ...
      let errorCallback
      jest
        .mocked(require('../../../../src/profiler/nestedCounters').nestedCountersInstance.countEvent)
