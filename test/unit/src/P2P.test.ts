...
describe('P2P', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks()
            ...
            ; ((Crypto.sign as jest.Mock) as any).mockImplementation((obj: Record<string, unknown>) => ({ ...obj, ...mockSignedObject }))
    })
    ...
    describe('createArchiverJoinRequest', () => {
        ...
        it('should call Crypto.sign with the correct join request', () => {
            ...
            expect(Crypto.sign).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('postJson', () => {
        ...
        it('should handle extreme timeout values', async () => {
            ...
            expect(customFetch).toHaveBeenCalledWith(mockUrl, expect.objectContaining({
                timeout: 0
            }))
